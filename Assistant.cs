...
namespace GoogleAssistantWindows
{
    ...
    {
        public delegate void DebugOutputDelegate(string debug, bool consoleOnly = false, string translatedText = "");
        ...
        {           
            ...
            if (response)
            {
                ...
                if (currentResponse.Result != null)
                {
                    ...
                    {
                        OnDebug?.Invoke("", false, currentResponse.Result.SpokenRequestText);
